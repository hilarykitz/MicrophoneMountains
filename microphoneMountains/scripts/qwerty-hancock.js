...
(function () {
    ...
    var init = function (us) {
        ...
        settings = {
            ...
            whiteKeyColour: user_settings.whiteKeyColour || 'pink',
            blackKeyColour: user_settings.blackKeyColour || 'rgb(136, 184, 255)',
            activeColour:   user_settings.activeColour || 'GOLD',
            borderColour:   user_settings.borderColour || '#73FFEC',
